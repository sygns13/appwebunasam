...
class EventoController extends Controller
{
    ...
    public function index1()
    {
        ...
        if(accesoUser([1,2]) || (accesoUser([3,4]) && accesoModulo($permisos, $rolModulos, $rolSubModulos, $nivel, $modulo, $submodulo))){
            ...
            return view('adminfacultad.evento.index',compact('tipouser','modulo','fecha', 'permisos','rolModulos','rolSubModulos','facultads'));
        }
        else
        {
            return redirect('home');    
    ...
    public function index2()
    {
        ...
        if(accesoUser([1,2]) || (accesoUser([3,4,5]) && accesoModulo($permisos, $rolModulos, $rolSubModulos, $nivel, $modulo, $submodulo))){
            ...
            return view('adminprograma.evento.index',compact('tipouser','modulo', 'permisos','rolModulos','rolSubModulos','programas','fecha'));
        }
        else
        {
            return redirect('home');    
