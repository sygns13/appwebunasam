<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Redes Sociales del Portal Web UNASAM <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
...
<div class="box box-success" v-if="divNuevo">
  ...
  @include('adminportal.redsocial.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('adminportal.redsocial.editar')  
    ...
    <table class="table table-hover table-bordered" >
      ...
      <tr v-for="redsocial, key in redsocials">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">{{-- @{{ redsocial.url }} --}}
          ...
          <center>
            <img v-bind:src="'{{ asset('/web/redsocialunasam/')}}'+'/'+redsocial.url" style="max-height: 100px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
            </center>
        </td>
