<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Banners del Portal Web UNASAM<a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
...
<div class="box box-success" v-if="divNuevo">
  ...
  @include('adminportal.banner.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('adminportal.banner.editar')  

</div>

<div class="panel panel-primary" >
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Banners del Portal Web UNASAM
    ...
    <table class="table table-hover table-bordered" >
      ...
      <tr v-for="banner, key in banners">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">{{-- @{{ banner.url }} --}}
          ...
          <center>
            <img v-bind:src="'{{ asset('/web/bannerunasam/')}}'+'/'+banner.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
            </center>
        </td>
