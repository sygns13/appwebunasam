 ...
 let app = new Vue({
    ...
    methods: {
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Link de Interés, No se mostrará en el Portal Web UNASAM, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Link de Interés, se mostrará en el Portal Web UNASAM en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
    ...
    numsig:function () {
        var url = '/intranet/linkinteresre/numsiguiente/0/0/0';
        axios.get(url).then(response=>{
