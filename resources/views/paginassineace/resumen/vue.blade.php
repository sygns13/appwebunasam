 ...
 let app = new Vue({
    ...
    data:{
      titulo:"Indicadores SINEACE Programas de Estudios",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'resumen':'' , 'tieneimagen':'1'},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/resumenre'+'?v1='+v1+'&v2='+v2+'&v3='+v3;

            this.fillobject = { 'id':'', 'titulo':'', 'resumen':'' , 'tieneimagen':'1'};
            ...
            axios.get(url).then(response=>{
               ...
               // console.log(resumen.length);
                ...
                if(resumen!= undefined && resumen != null){
                    this.fillobject.id = resumen.id;
                    this.fillobject.titulo = resumen.titulo;
                    this.fillobject.resumen = resumen.resumen;
                    this.fillobject.tieneimagen = resumen.tieneimagen;
                    this.detalleImagenes = resumen.imagenresumen;
       ...
       /*  verImg:function () {
        ...
        if(this.fillobject.tieneimagen!= null && this.fillobject.tieneimagen == 1){
            $("#imgInformacion").attr("src","{{ asset('/web/resumenfec/')}}"+"/"+image);
        }
        ...
        create:function () {
            ...
            this.resumen=CKEDITOR.instances['editor1'].getData();
            ...
            data.append('resumen', this.resumen);
        ...
        //Seccion Imagenes de detalle Resumen
      ...
      createImg:function () {
          var url='/intranet/imagenresumenre';
          ...
          data.append('resumen_id', this.fillobject.id);
          data.append('v1', v1);
          data.append('v2', v2);
          data.append('v3', v3);
      ...
      getDatosImagenes: function () {
          ...
          var url = '/intranet/imagenresumenre?resumen_id='+this.fillobject.id;
          axios.get(url).then(response=>{
              this.detalleImagenes= response.data.imagenresumen;
          })
      },
      borrarImg:function (dato) {
        swal.fire({
          ...
          if (result.value) {
              var url = '/intranet/imagenresumenre/'+dato.id;
      ...
      editImg:function (dato) {
        ...
        updateImg: function (id) {
          ...
          var url="/intranet/imagenresumenre/"+id;
     ...
     irAtras:function(){
      ...
      numsig:function (num) {
        var url = '/intranet/imagenresumenre/numsiguiente/'+num;
        axios.get(url).then(response=>{
