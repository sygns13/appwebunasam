<script type="text/javascript">
 let app = new Vue({
    el: '#app',
    data:{
        titulo:"Portal Web Programas de Estudios",
        subtitulo: "Gestión de Links de Interés",
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/linkinteresre?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;

            axios.get(url).then(response=>{

                this.linkinteress= response.data.linkinteress.data;
                this.pagination= response.data.pagination;

                //this.mostrarPalenIni=true;

                if(this.linkinteress.length==0 && this.thispage!='1'){
        ...
        create:function () {
            var url='/intranet/linkinteresre';
        ...
        borrar:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "¿Desea eliminar el Link de Interés seleccionado? -- Nota: Este proceso no se podrá revertir",
              type: 'info',
            ...
            if (result.value) {
                var url = '/intranet/linkinteresre/'+dato.id;
        ...
        update: function (id) {
            ...
            var url="/intranet/linkinteresre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Link de Interés, No se mostrará en el Portal del Programa de Estudio, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/linkinteresre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Link de Interés, se mostrará en el Portal del Programa de Estudio en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/linkinteresre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
    ...
    numsig:function () {
        var url = '/intranet/linkinteresre/numsiguiente/2/0/'+this.programa_id;
        axios.get(url).then(response=>{
