...
<div class="panel panel-primary" v-if="mostrarPalenIni && programa_id!=0">
  ...
  <div class="panel-body">
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" id="btncrear" style="font-size: 14px;" @click.prevent="nuevo()"><i class="fa fa-edit" aria-hidden="true" ></i> Diseño del Portal del Programa de Estudio</button>
        <button type="button" class="btn btn-primary btn-sm" id="btncrear" style="font-size: 14px;" @click.prevent="nuevoLogo()"><i class="fa fa-edit" aria-hidden="true" ></i> Logo del Portal del Programa de Estudio</button>
      </div>
    </div>
  </div>
</div>
...
<div class="box box-success" v-if="divNuevo && programa_id!=0">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Gestión del Diseño  del Programa de Estudio de @{{programa}}
    </h3>
  </div>
  @include('adminprograma.configuracion.formulario')  
</div>

<div class="box box-success" v-if="divNuevoLogo && programa_id!=0">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Gestión del Logo  del Programa de Estudio de @{{programa}}
    </h3>
  </div>
  @include('adminprograma.configuracion.formulariologo')  
</div>
