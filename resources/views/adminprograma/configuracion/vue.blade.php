 ...
 let app = new Vue({
    ...
    methods: {
            ...
            axios.get(url).then(response=>{
               ...
               // console.log(programa.length);
                ...
                if(programa!= undefined && programa != null){
                    ...
                    this.fillobject.tipo_vista = programa.tipo_vista;
                    this.fillobject.logourl = programa.logourl;
                    this.cancelForm();
                    this.$nextTick(() => {
                      this.verImg();
                    })
        ...
        if(this.fillobject.logourl!= null && this.fillobject.logourl.trim() != ''){
            $("#imgInformacion").attr("src","{{ asset('/web/logoprograma/')}}"+"/"+image);
        }
        ...
        create:function () {
            var url='/intranet/datosprogramare/configuracion';
        ...
        createLogo:function () {
            var url='/intranet/datosprogramare/logo';
