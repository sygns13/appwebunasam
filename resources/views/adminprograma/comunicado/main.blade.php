...
<div class="panel panel-primary" v-if="mostrarPalenIni && programa_id!=0">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Comunicados del Programa de Estudio de @{{programa}} <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="#"  @click.prevent="irAtras()"><i class="fa fa-reply-all" aria-hidden="true"></i> 
      Ir Atrás</a></h3>
...
<div class="box box-success" v-if="divNuevo && programa_id!=0">
  ...
  @include('adminprograma.comunicado.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit && programa_id!=0">
  ...
  @include('adminprograma.comunicado.editar')  

</div>

<div class="panel panel-primary" v-if="programa_id!=0">
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Comunicados del Programa de Estudio de @{{programa}}
        ...
        <td style="border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
          ...
          <template v-for="images, key2 in comunicado.imagencomunicado">
            <center v-if="images.posicion == 0">
              <img v-bind:src="'{{ asset('/web/comunicadoprograma/')}}'+'/'+images.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
              </center>
          </template>
...
@include('adminprograma.comunicado.detalleimagenes')  