                                        ...
                                        @if($image1 != null && $image1->url != null)
                                            <div class="post-image ms-0">
												<center>
                                                    ...
                                                    <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/noticiafacultad/'.$image1->url) }}"  data-plugin-options="{'type':'image'}">
                                                        <img class="img-fluid" src="{{ asset('/web/noticiafacultad/'.$image1->url) }}" alt="Noticia" style="width: 100%; max-height: 500px;">
                                                    </a>
												</center>
                                            </div>
                                        @endif
                        ...
                        @if($key%2 != 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    ...
                                    <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/noticiafacultad/'.$dato->url) }}"  data-plugin-options="{'type':'image'}">
                                        <img class="img-fluid" src="{{ asset('/web/noticiafacultad/'.$dato->url) }}" alt="Noticia" style="width: 100%; max-height: 360px;;">
                                    </a>
                                </div>
