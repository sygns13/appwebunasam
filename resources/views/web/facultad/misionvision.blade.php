                    ...
                    <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                        <div class="col-md-5 mb-5 mb-md-0">
                            @if($mision != null && $mision->url)
                                {{-- <img class="img-fluid scale-2 pe-5 pe-md-0 my-4" src="{{ asset('/web/misionvisionfacultad/'.$mision->url) }}" alt="Mision" /> --}}

                                <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/misionvisionfacultad/'.$mision->url) }}"  data-plugin-options="{'type':'image'}">
                                    <img class="img-fluid" src="{{ asset('/web/misionvisionfacultad/'.$mision->url) }}" alt="Mision" style="width: 100%; height: 280px;">
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="row align-items-center py-5 appear-animation" data-appear-animation="fadeInRightShorter">
                        ...
                        <div class="col-md-5 px-5 px-md-3">
                            @if($vision != null && $vision->url)
                                {{-- <img class="img-fluid scale-2 pe-5 pe-md-0 my-4" src="{{ asset('/web/misionvisionfacultad/'.$vision->url) }}" alt="Visión" /> --}}

                                <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/misionvisionfacultad/'.$vision->url) }}"  data-plugin-options="{'type':'image'}">
                                    <img class="img-fluid" src="{{ asset('/web/misionvisionfacultad/'.$vision->url) }}" alt="Visión" style="width: 100%; height: 280px;">
                                </a>
                            @endif
                        </div>
                    </div>
