                        ...
                        @if($key%2 != 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    ...
                                    <a class="lightbox" href="{{ asset('/web/objetivofacultad/'.$dato->url) }}" data-plugin-options="{'type':'image'}">
                                        <img class="img-thumbnail d-block lightbox" src="{{ asset('/web/objetivofacultad/'.$dato->url) }}" alt="Objetivo" style="width: 100%; height: 280px;">
                                    </a>
                                </div>
                        ...
                        @else
                            <div class="row align-items-center py-5 appear-animation" data-appear-animation="fadeInRightShorter">
                                <div class="col-md-7 pe-md-5 mb-5 mb-md-0">
                                    ...
                                    @endif
                                    @if($dato->descripcion != null)
                                        <p class="text-5">{!! $dato->descripcion !!}</p>
                                    @endif
                                </div>
