                                    ...
                                    <div class="col-lg-12">
                                        <ul class="pagination" style="float:right;">
                                            @if($pagination->current_page > 1)
                                                <li class="page-item"><a class="page-link" href="/programadeestudio/{{$escuela->hash}}/eventos?page=1">Inicio</a></li>
                                                <li class="page-item"><a class="page-link" href="/programadeestudio/{{$escuela->hash}}/eventos?page={{$pagination->current_page-1}}"><i class="fas fa-angle-left"></i></a></li>
                                            @endif
                                            ...
                                            @foreach($pagesNumber as  $page)
                                                ...
                                                @else
                                                    <li class="page-item"><a class="page-link" href="/programadeestudio/{{$escuela->hash}}/eventos?page={{$page}}">{{$page}}</a></li>
                                                @endif
                                            @endforeach

                                            @if($pagination->current_page < $pagination->last_page)
                                                <li class="page-item"><a class="page-link" href="/programadeestudio/{{$escuela->hash}}/eventos?page={{$pagination->current_page+1}}"><i class="fas fa-angle-right"></i></a></li>
                                                <li class="page-item"><a class="page-link" href="/programadeestudio/{{$escuela->hash}}/eventos?page={{$pagination->last_page}}">Final</a></li>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-5">
                                    <div class="post-image">
                                        <a href="/programadeestudio/evento/{{$dato->hash}}/{{$escuela->hash}}">
                                            @if($dato->imageneventos != null && $dato->imageneventos->count() >0 && $dato->imageneventos[0]->url != null)
                                                <img src="{{ asset('/web/eventoprograma/'.$dato->imageneventos[0]->url) }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" id="imgEvento-{{$dato->id}}" />
                                            @else
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="post-meta">
                                        ...
                                        <span class="d-block d-sm-inline-block float-sm-end mt-3 mt-sm-0"><a href="/programadeestudio/evento/{{$dato->hash}}/{{$escuela->hash}}" class="btn btn-xs btn-light text-1 text-uppercase">Leer más</a></span>
                                    </div>
                                </div>
                            </div>
                        </article>
