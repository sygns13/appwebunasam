                                    ...
                                    @endphp
                                        @if($image1 != null && $image1->url != null)
											<div class="col-md-7 px-8 px-md-6">
                                                {{-- <img src="{{ asset('/web/eventoprograma/'.$image1->url) }}"  class="img-fluid float-start me-4 mt-2" alt=""/> --}}

                                                <a class="img-thumbnail d-block lightbox float-start me-4 mt-2" href="{{ asset('/web/eventoprograma/'.$image1->url) }}"  data-plugin-options="{'type':'image'}">
                                                    <img class="img-fluid" src="{{ asset('/web/eventoprograma/'.$image1->url) }}" alt="Evento" style="width: 100%; max-height: 500px;">
                                                </a>
											</div>
                                        @endif
                                    @endif
                        ...
                        @if($key%2 == 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    {{-- <img class="img-fluid scale-2 pe-5 pe-md-0 my-4" src="{{ asset('/web/eventoprograma/'.$dato->url) }}" alt="{{$dato->nombre}}" /> --}}

                                    <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/eventoprograma/'.$dato->url) }}"  data-plugin-options="{'type':'image'}">
                                        <img class="img-fluid" src="{{ asset('/web/eventoprograma/'.$dato->url) }}" alt="Evento" style="width: 100%; max-height: 360px;;">
                                    </a>
                                </div>
