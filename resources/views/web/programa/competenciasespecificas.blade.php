	...
	<body>
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-light font-weight-bold text-8">Competencias Específicas del</h1>
                ...
                @foreach($competenciasespecificas as  $key => $dato)
...
{{-- 									<div class="post-date ms-0">
									...
									<div class="post-content ms-0">
                                        ...
                                        <div class="col-md-6 px-7 px-md-5">
											...
											<a class="img-thumbnail d-block lightbox float-start me-4 mt-2" href="{{ asset('/web/indicadorsineaceprograma/'.$dato->url) }}" data-plugin-options="{'type':'image'}">
