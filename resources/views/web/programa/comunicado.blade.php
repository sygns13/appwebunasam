					...
					<div class="row py-4 mb-2">
						...
						@if($comunicado != null && $comunicado->imagencomunicados != null &&  $comunicado->imagencomunicados->count() > 0)
							...
							@endphp
								...
								{{-- <img src="{{ asset('/web/comunicadoprograma/'.$image1->url) }}" class="img-fluid mb-2" alt=""> --}}

								<a class="img-thumbnail d-block lightbox float-start me-4 mt-2" href="{{ asset('/web/comunicadoprograma/'.$image1->url) }}"  data-plugin-options="{'type':'image'}">
									<img class="img-fluid" src="{{ asset('/web/comunicadoprograma/'.$image1->url) }}" alt="Actividad" style="width: 100%; max-height: 500px;">
								</a>
								@endif
						@endif
                        ...
                        @if($key%2 != 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    {{-- <img class="img-fluid scale-2 pe-5 pe-md-0 my-4" src="{{ asset('/web/comunicadoprograma/'.$dato->url) }}" alt="{{$dato->nombre}}" /> --}}

									<a class="img-thumbnail d-block lightbox" href="{{ asset('/web/comunicadoprograma/'.$dato->url) }}"  data-plugin-options="{'type':'image'}">
                                        <img class="img-fluid" src="{{ asset('/web/comunicadoprograma/'.$dato->url) }}" alt="Actividad" style="width: 100%; max-height: 360px;;">
                                    </a>
                                </div>
