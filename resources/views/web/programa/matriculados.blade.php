					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-light font-weight-bold text-8">Número de Matriculados del</h1>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 50%;"><center>
                                Número de Matriculados</center>
                            </th>

                        </tr>
                    </thead>
                    <tbody>
                        @foreach($matriculados as  $key => $dato)
                            <tr>
                                <td>
                                    {{$key+1}}
                                </td>
            ...
            $(document).ready(function() {
                ...
                Highcharts.chart('containerchar', {
                    ...
                    tooltip: {
                        ...
                        pointFormat: '<span style="color:{point.color}">{point.name}</span>: <b>{point.y}</b> matriculados<br/>'
                    },
