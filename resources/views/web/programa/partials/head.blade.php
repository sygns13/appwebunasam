<head>
    ...
    <title>Portal del Programa de Estudios {{$escuela->nombre}}</title>

    <meta name="keywords" content="Programa de Estudio, {{$escuela->nombre}} ,universidad, Huaraz, Ancash, Perú, Programa de Estudio, Universidad Nacional, universidad Huaraz, Santiago Antúnez, Santiago Antúnez de Mayolo, Antúnez de Mayolo" />
<meta name="description" content="{{$escuela->nombre}} de la Universidad Nacional Santiago Antunez de Mayolo ubicada en la ciudad de Huaraz Ancash-Perú">
<meta name="author" content="Ing. Cristian Chávez - Construyendo Soluciones Informáticas E.I.R.L.">
    ...
    <!-- Demo CSS -->
    <link rel="stylesheet" href="{{ asset('/webvendor/css/demos/demo-business-consulting-2.css') }}">

    <!-- Skin CSS -->
    <link id="skinCSS" rel="stylesheet" href="{{ asset('/webvendor/css/skins/skin-business-consulting-2.css') }}">
