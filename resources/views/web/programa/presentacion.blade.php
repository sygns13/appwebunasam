					...
					<div class="container">
						...
						<section class="page-header page-header-modern bg-color-light-scale-2 page-header-md" style="background: #2d529f!important;">
							...
							<div class="row mt-5 mb-5 pt-3 pb-3">
								...
								<div class="col-md-4">
									{{-- <img src="{{ asset('/web/presentacionprograma/'.$presentacion->url)}}" alt class="img-fluid box-shadow-custom" />  --}}

									<a class="img-thumbnail d-block lightbox" href="{{ asset('/web/presentacionprograma/'.$presentacion->url)}}" data-plugin-options="{'type':'image'}">
										<img class="img-fluid" src="{{ asset('/web/presentacionprograma/'.$presentacion->url)}}" width="500" height="400" alt="Project Image">
									</a>
								</div>
								@endif
							</div>
