                                    ...
                                    @endphp
                                        @if($image1 != null && $image1->url != null)
                                            <div class="post-image ms-0">
                                                ...
                                                <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/historiaunasam/'.$image1->url) }}"  data-plugin-options="{'type':'image'}">
                                                    <img class="img-fluid" src="{{ asset('/web/historiaunasam/'.$image1->url) }}" alt="Project Image" style="width: 100%; height: 390px;">
                                                </a>
                                            </div>
                                        @endif
                                    @endif
                        ...
                        @if($key%2 != 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    ...
                                    <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/historiaunasam/'.$dato->url) }}"  data-plugin-options="{'type':'image'}">
                                        <img class="img-fluid" src="{{ asset('/web/historiaunasam/'.$dato->url) }}" alt="Project Image" style="width: 100%; height: 280px;">
                                    </a>
