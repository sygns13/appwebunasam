                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 align-self-center p-static order-2 text-center">
                            ...
                            <span class="sub-title text-light">Universidad Nacional Santiago Antúnez de Mayolo</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                        <div class="col-md-5 mb-5 mb-md-0">
                            @if($mision != null && $mision->url)
                                ...
                                <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/misionvisionunasam/'.$mision->url) }}"  data-plugin-options="{'type':'image'}">
                                    <img class="img-fluid" src="{{ asset('/web/misionvisionunasam/'.$mision->url) }}" alt="Mision" style="width: 100%; height: 280px;">
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="row align-items-center py-5 appear-animation" data-appear-animation="fadeInRightShorter">
                        ...
                        <div class="col-md-5 px-5 px-md-3">
                            @if($vision != null && $vision->url)
                                ...
                                <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/misionvisionunasam/'.$vision->url) }}"  data-plugin-options="{'type':'image'}">
                                    <img class="img-fluid" src="{{ asset('/web/misionvisionunasam/'.$vision->url) }}" alt="Visión" style="width: 100%; height: 280px;">
                                </a>
                            @endif
                        </div>
                    </div>
