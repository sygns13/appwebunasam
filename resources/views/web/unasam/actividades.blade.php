                        ...
                        <div class="blog-posts">
                            ...
                            <article class="post post-large">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-meta">
                                        <span class="d-block d-sm-inline-block float-sm-end mt-3 mt-sm-0"><a href="actividad/{{$dato->hash}}" class="btn btn-xs btn-light text-1 text-uppercase">Ver Más</a></span>
                                    </div>
