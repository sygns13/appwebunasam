					...
					<div class="row py-4 mb-2">
						<div class="col-md-7 order-2">
							...
							<div class="overflow-hidden mb-3">
								<p class="font-weight-bold text-primary text-uppercase mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="500">Vicerrector Académico</p>
							</div>
