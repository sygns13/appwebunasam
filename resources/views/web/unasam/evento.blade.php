                                    ...
                                    @endphp
                                        @if($image1 != null && $image1->url != null)
											<div class="col-md-7 px-8 px-md-6">
                                                    ...
                                                    <a class="img-thumbnail d-block lightbox float-start me-4 mt-2" href="{{ asset('/web/eventounasam/'.$image1->url) }}"  data-plugin-options="{'type':'image'}">
                                                        <img class="img-fluid" src="{{ asset('/web/eventounasam/'.$image1->url) }}" alt="Evento" style="width: 100%; max-height: 500px;">
                                                    </a>
											</div>
                                        @endif
                                    @endif
                        ...
                        @if($key%2 != 0)
                            <div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
                                <div class="col-md-5 mb-5 mb-md-0">
                                    ...
                                    <a class="img-thumbnail d-block lightbox" href="{{ asset('/web/eventounasam/'.$dato->url) }}"  data-plugin-options="{'type':'image'}">
                                        <img class="img-fluid" src="{{ asset('/web/eventounasam/'.$dato->url) }}" alt="Evento" style="width: 100%; max-height: 360px;;">
                                    </a>
