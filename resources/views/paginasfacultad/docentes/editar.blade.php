<form method="post" v-on:submit.prevent="update(fillobject.id)">
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12"  v-if="facultad_id != 0">
      <div class="form-group">
        <label for="cbudepartamentoacademico_idE class="col-sm-2 control-label">Departamento Académico:<spam style="color:red;">*</spam></label>
        <div class="col-sm-10">
          <select class="form-control" id="cbudepartamentoacademico_idE name="cbudepartamentoacademico_idE v-model="fillobject.departamentoacademico_id">
  ...
  <span style="color:red">Ingrese una Imagen o un archivo adjunto solo si va a editar la Imagen</span>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo2E" class="col-sm-2 control-label">Descripción de Experiencia Personal: (Opcional)</label>
            <div class="col-sm-10">
              <ckeditor6 v-model="content6"></ckeditor6>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo3E" class="col-sm-2 control-label">Descripción de Publicaciones: (Opcional)</label>
            <div class="col-sm-10">
              <ckeditor7 v-model="content7"></ckeditor7>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo4E" class="col-sm-2 control-label">Descripción de Investigaciones: (Opcional)</label>
            <div class="col-sm-10">
              <ckeditor8 v-model="content8"></ckeditor8>
