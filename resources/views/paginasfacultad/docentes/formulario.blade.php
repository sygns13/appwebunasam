<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12"  v-if="facultad_id != 0">
      <div class="form-group">
        <label for="cbudepartamentoacademico_id" class="col-sm-2 control-label">Departamento Académico:<spam style="color:red;">*</spam></label>
        <div class="col-sm-10">
          <select class="form-control" id="cbudepartamentoacademico_id" name="cbudepartamentoacademico_id" v-model="departamentoacademico_id">
            <option disabled value="0">Seleccione un Departamento Académico</option>
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          ...
          <label for="txttelefono" class="col-sm-2 control-label">Teléfono del Docente: (Opcional)</label>
          <div class="col-sm-2">
          ...
          <label for="txtemail" class="col-sm-2 control-label">Email del Docente: (Opcional)</label>
          <div class="col-sm-6">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo2" class="col-sm-2 control-label">Descripción de Experiencia Personal: (Opcional)</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo3" class="col-sm-2 control-label">Descripción de Publicaciones: (Opcional)</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
            <label for="txtdesarrollo4" class="col-sm-2 control-label">Descripción de Investigaciones: (Opcional)</label>
            <div class="col-sm-10">
