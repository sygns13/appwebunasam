...
<div class="panel panel-primary" v-if="mostrarPalenIni && facultad_id!=0">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Documentos Normativos de la @{{facultad}} <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="#"  @click.prevent="irAtras()"><i class="fa fa-reply-all" aria-hidden="true"></i> 
      Ir Atrás</a></h3>
...
<div class="box box-success" v-if="divNuevo && facultad_id!=0">
  ...
  @include('paginasfacultad.documento.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit && facultad_id!=0">
  ...
  @include('paginasfacultad.documento.editar')  

</div>

<div class="panel panel-primary" v-if="facultad_id!=0">
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Documentos Normativos de la @{{facultad}}
    ...
    <table class="table table-hover table-bordered" >
      ...
      <tr v-for="documento, key in documentos">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
          <center>
              <a v-bind:href="'{{ asset('/web/documentofacultad/')}}'+'/'+documento.url"  class="btn btn-primary btn-xs" download> Descargar</a>
            </center>
        </td>
