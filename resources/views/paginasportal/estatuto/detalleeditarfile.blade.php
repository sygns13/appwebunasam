    ...
    <div class="box-body" style="font-size: 14px;">
        ...
        <div class="col-md-12" style="padding-top: 15px;">
            <div class="form-group">
              <label for="txtnombreImgE" class="col-sm-2 control-label">Nombre de la Modificatoria:*</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="txtnombreImgE" name="txtnombreImgE" placeholder="Nombre de la Modificatoria"
          ...
          <div class="col-md-12" style="padding-top: 15px;">
            ...
            <div class="form-group">
                <label for="txtposicionE" class="col-sm-2 control-label">Posición de la Modificatoria:*</label>
                <div class="col-sm-4">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
            ...
            <div class="form-group">
                <label for="txtdescripcionImgE" class="col-sm-2 control-label">Descripción de la Modificatoria: (opcional)</label>
                <div class="col-sm-10">
          ...
          <div class="col-md-12" style="padding-top: 15px;">
            ...
            <div class="form-group">
              <label for="imagenEDetalle" class="col-sm-2 control-label">Archivo: (Opcional)</label>
      ...
      accept=".pdf, .PDF"/>
      <span style="color:red">Ingrese un Archivo PDF solo si va a editar el archivo cargado</span>
