    ...
    <div class="box-body" style="font-size: 14px;">
        ...
        <div class="col-md-12" style="padding-top: 15px;">
          <div class="form-group">
            <label for="txtnombreImg" class="col-sm-2 control-label">Nombre de la Modificatoria:*</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtnombreImg" name="txtnombreImg" placeholder="Nombre de la Modificatoria"
        ...
        <div class="col-md-12" style="padding-top: 15px;">
          ...
          <div class="form-group">
              <label for="txtposicion" class="col-sm-2 control-label">Posición de la Modificatoria:*</label>
              <div class="col-sm-4">
        ...
        <div class="col-md-12" style="padding-top: 15px;">
          ...
          <div class="form-group">
              <label for="txtdescripcionImg" class="col-sm-2 control-label">Descripción de la Modificatoria: (opcional)</label>
              <div class="col-sm-10">
        ...
        <div class="col-md-12" style="padding-top: 15px;">
          <div class="form-group">
            <label for="imagenDetalle" class="col-sm-2 control-label">Seleccione Archivo (Formato PDF):</label>
            <div class="col-sm-10">
              <input name="imagenDetalle" type="file" id="imagenDetalle" class="archivo form-control" @change="getImageDetalle"  v-if="uploadReadyDetalle" accept=".pdf, .PDF"/>
            </div>
            </div>
        </div>  
