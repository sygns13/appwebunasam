 ...
 let app = new Vue({
    ...
    data:{
      titulo:"Páginas UNASAM",
        subtitulo: "Gestión del Estatuto",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'descripcion':'' , 'tieneimagen':'0', 'url':'','oldFile':''},
        ...
        // Gestionar imagenes de estatuto
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v2 = 0;
            var v3 = 0;
            var url = '/intranet/estatutore'+'?v1='+v1+'&v2='+v2+'&v3='+v3;;

            axios.get(url).then(response=>{

                let estatuto= response.data.estatuto;
                //console.log(estatuto);
               // console.log(estatuto.length);

                if(estatuto!= undefined && estatuto != null){
                    this.fillobject.id = estatuto.id;
                    this.fillobject.titulo = estatuto.titulo;
                    this.fillobject.subtitulo = estatuto.subtitulo;
                    this.fillobject.descripcion = estatuto.descripcion;
                    this.fillobject.tieneimagen = estatuto.tieneimagen;
                    this.fillobject.url = estatuto.url;
                    this.fillobject.oldFile = estatuto.url;
                    this.documentoEstatuto = estatuto.documentoEstatuto;
                    this.$nextTick(() => {
                      this.verImg();
                    })
                }
        ...
        if(this.fillobject.tieneimagen!= null && this.fillobject.tieneimagen == 1){
            $("#fileInformacion").attr("src","{{ asset('/web/estatutounasam/')}}"+"/"+image);
        }
        ...
        getArchivo(event){
            //Asignamos la archivo a  nuestra data
      ...
      createImg:function () {
        var url='/intranet/docuemntoestatutore';
        ...
        data.append('estatuto_id', this.fillobject.id);
        data.append('v1', v1);
        data.append('v2', v2);
        data.append('v3', v3);
      ...
      getDatosImagenes: function () {
        ...
        var url = '/intranet/docuemntoestatutore?estatuto_id='+this.fillobject.id;
        axios.get(url).then(response=>{
            this.documentoEstatuto= response.data.documentoEstatuto;
        })
      },
      ...
      swal.fire({
        ...
        if (result.value) {
            var url = '/intranet/docuemntoestatutore/'+dato.id;
      ...
      updateImg: function (id) {
        ...
        var url="/intranet/docuemntoestatutore/"+id;
      ...
      numsig:function (num) {
        var url = '/intranet/docuemntoestatutore/numsiguiente/'+num;
        axios.get(url).then(response=>{
