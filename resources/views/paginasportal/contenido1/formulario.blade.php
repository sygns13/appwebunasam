<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Nombre del Himno:*</label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtmediaurl" class="col-sm-2 control-label">URL de contenido</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txtmediaurl" name="txtmediaurl" placeholder=""
              maxlength="500" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="mediaurl">
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
            <label for="txtpresentacion" class="col-sm-2 control-label">Contenido del Himno:*</label>
            <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="cbutieneimagen" class="col-sm-2 control-label">¿Incluye imagen?:*</label>
          <div class="col-sm-4">
  ...
  <div class="col-md-12" style="padding-top: 15px;" v-if="tieneimagen==1">
    ...
    <div class="form-group">
      <label for="cbuarchivo" class="col-sm-2 control-label">Imagen del Himno</label>
