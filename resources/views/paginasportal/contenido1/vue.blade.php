...
Vue.component('ckeditor1', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        subtitulo : "Gestión del Himno Institucional",
        ...
        fillobject:{ 'id':'', 'titulo':'','mediaurl':'', 'descripcion':'' , 'tieneimagen':'0', 'url':'','oldImg':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var tipo = 1;
            var url = '/intranet/contenidosre'+'?v1='+v1+'&v2='+v2+'&v3='+v3+'&tipo='+tipo;
            ...
            axios.get(url).then(response=>{
               ...
               // console.log(contenido.length);
                ...
                if(contenido!= undefined && contenido != null){
                    this.fillobject.id = contenido.id;
                    this.fillobject.titulo = contenido.titulo;
                    this.fillobject.mediaurl = contenido.mediaurl;
                    this.fillobject.descripcion = contenido.descripcion;
                    this.fillobject.tieneimagen = contenido.tieneimagen;
                    this.fillobject.url = contenido.url;
                    this.fillobject.oldImg = contenido.url;
                    this.$nextTick(() => {
                      this.verImg();
                      /* this.verContenido(); */
                    })
        ...
        if(this.fillobject.tieneimagen!= null && this.fillobject.tieneimagen == 1){
            $("#imgInformacion").attr("src","{{ asset('/web/contenidounasam/')}}"+"/"+image);
        }
        
        },
/* 
        verContenido:function () {

          let media=this.fillobject.mediaurl;
          if(this.fillobject.mediaurl!= null && this.fillobject.mediaurl.trim().length > 0){
              $("#contenidoID").attr("src", mediaurl);
          }
        ...
        cancelForm: function () {
            ...
            this.mediaurl = this.fillobject.mediaurl;
        ...
        create:function () {
            ...
            data.append('mediaurl', this.mediaurl);
