<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Nombre:*</label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtsubtitulo" class="col-sm-2 control-label">Descripción corta de la Asamblea Universitaria</label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
            <label for="txtpresentacion" class="col-sm-2 control-label">Descripción de la Asamblea Universitaria:*</label>
            <div class="col-sm-10">
  ...
  <div class="col-md-12" style="padding-top: 15px;" v-if="tieneimagen==1">
    ...
    <div class="form-group">
      <label for="cbuarchivo" class="col-sm-2 control-label">Imagen de la Asamblea Universitaria</label>
