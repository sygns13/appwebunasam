<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Informes y Publicaciones de la UNASAM<a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
...
<div class="panel-body">
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <button type="button" class="btn btn-primary btn-sm" id="btncrear" style="font-size: 14px;" @click.prevent="nuevo()"><i class="fa fa-plus-circle" aria-hidden="true" ></i> Nuevo Informe o Publicación</button>
      </div>
    </div>
  </div>
</div>
...
<div class="box box-success" v-if="divNuevo">
  <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
    <h3 class="box-title" id="tituloAgregar">Nuevo Informe o Publicación
    </h3>
  </div>
  @include('paginasportal.informe.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  <div class="box-header with-border" style="border: 1px solid #f39c12; background-color: #f39c12; color: white;">
    <h3 class="box-title" id="tituloAgregar">Editar Informe o Publicación: @{{ fillobject.nombre }}


    </h3>
  </div>

  @include('paginasportal.informe.editar')  

</div>

<div class="panel panel-primary" >
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Informes y Publicaciones de la UNASAM
  ...
  <div class="box-body table-responsive">
    <table class="table table-hover table-bordered" >
      <tbody><tr>
        ...
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 5%;">Orden de Publicación</th>
        ...
        <th style=";border:1px solid #ddd; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; padding: 5px; width: 10%;">Informe o Publicación</th>
      ...
      <tr v-for="documento, key in documentos">
       ...
       <td style=";border:1px solid #ddd; font-size: 11px; padding: 5px;">
        ...
        <a href="#" v-if="documento.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="baja(documento)" data-placement="top" data-toggle="tooltip" title="Desactivar Informe"><i class="fa fa-arrow-circle-down"></i></a>
        <a href="#" v-if="documento.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="alta(documento)" data-placement="top" data-toggle="tooltip" title="Activar Informe"><i class="fa fa-check-circle"></i></a>


        <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="edit(documento)" data-placement="top" data-toggle="tooltip" title="Editar Informe"><i class="fa fa-edit"></i></a>
        <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(documento)" data-placement="top" data-toggle="tooltip" title="Borrar Informe"><i class="fa fa-trash"></i></a>
