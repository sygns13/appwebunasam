...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        subtitulo: "Gestión de Informes o Publicaciones",
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v2 = 0;
            var v3 = 0;
            var url = '/intranet/documentore?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3+'&tipo='+this.tipo;
        ...
        borrar:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "¿Desea eliminar el Informe o Publicación seleccionado? -- Nota: Este proceso no se podrá revertir",
              type: 'info',
            ...
            if (result.value) {
                var url = '/intranet/documentore/'+dato.id;
        ...
        update: function (id) {
            ...
            var url="/intranet/documentore/"+id;
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Informe o Publicación, No se mostrará en el Portal Web UNASAM, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/documentore/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Informe o Publicación, se mostrará en el Portal Web UNASAM en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/documentore/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
    ...
    numsig:function () {
        var url = '/intranet/documentore/numsiguiente/0/0/0/2';
        axios.get(url).then(response=>{
