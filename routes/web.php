...
Route::get('facultad/departamentoacademico/{var1}/{var2}', 'IndexFacultadWebController@departamentoacademico');
...
Route::get('facultad/docente/{var}','IndexFacultadWebController@docente');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('intranet/competenciasespecificasprograma', 'IndicadorsineaceController@index03');
